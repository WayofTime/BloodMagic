...
public class BloodMagicTileEntities
{
	...
	public static final RegistryObject<BlockEntityType<TileShapedExplosive>> SHAPED_EXPLOSIVE_TYPE = TILE_ENTITIES.register("shaped_explosive", () -> BlockEntityType.Builder.of(TileShapedExplosive::new, BloodMagicBlocks.SHAPED_CHARGE.get()).build(null));
	public static final RegistryObject<BlockEntityType<TileDeforesterCharge>> DEFORESTER_CHARGE_TYPE = TILE_ENTITIES.register("deforester_charge", () -> BlockEntityType.Builder.of(TileDeforesterCharge::new, BloodMagicBlocks.DEFORESTER_CHARGE.get()).build(null));
	public static final RegistryObject<BlockEntityType<TileVeinMineCharge>> VEINMINE_CHARGE_TYPE = TILE_ENTITIES.register("veinmine_charge", () -> BlockEntityType.Builder.of(TileVeinMineCharge::new, BloodMagicBlocks.VEINMINE_CHARGE.get()).build(null));
	public static final RegistryObject<BlockEntityType<TileFungalCharge>> FUNGAL_CHARGE_TYPE = TILE_ENTITIES.register("fungal_charge", () -> BlockEntityType.Builder.of(TileFungalCharge::new, BloodMagicBlocks.FUNGAL_CHARGE.get()).build(null));
