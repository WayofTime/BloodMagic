...
//		ConditionalRecipe.builder().addRecipe(ShapedRecipeBuilder.shapedRecipe(BloodMagicItems.SACRIFICIAL_DAGGER.get()).key('g', Tags.Items.GLASS).key('G', Tags.Items.INGOTS_GOLD).key('i', Tags.Items.INGOTS_IRON).patternLine("ggg").patternLine(" Gg").patternLine("i g").addCriterion("has_glass", hasItem(Items.GLASS))::build);
		...
		ShapelessRecipeBuilder.shapelessRecipe(BloodMagicItems.ALCHEMY_FLASK_THROWABLE.get()).addIngredient(BloodMagicItems.ALCHEMY_FLASK_THROWABLE.get()).addIngredient(Ingredient.fromItems(Items.WATER_BUCKET)).addCriterion("has_flask", hasItem(BloodMagicItems.ALCHEMY_FLASK.get())).build(consumer, BloodMagic.rl("alchemy_flask_throwable"));
		ShapelessRecipeBuilder.shapelessRecipe(BloodMagicItems.ALCHEMY_FLASK_LINGERING.get()).addIngredient(BloodMagicItems.ALCHEMY_FLASK_LINGERING.get()).addIngredient(Ingredient.fromItems(Items.WATER_BUCKET)).addCriterion("has_flask", hasItem(BloodMagicItems.ALCHEMY_FLASK.get())).build(consumer, BloodMagic.rl("alchemy_flask_lingering"));
