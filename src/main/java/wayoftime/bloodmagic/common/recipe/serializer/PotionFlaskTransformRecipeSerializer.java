...
public class PotionFlaskTransformRecipeSerializer<RECIPE extends RecipePotionFlaskTransform> extends ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<RECIPE>
{
