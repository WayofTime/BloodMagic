...
public class PotionRecipeProvider implements ISubRecipeProvider
{
	...
	public void addRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		PotionEffectRecipeBuilder.potionEffect(MobEffects.REGENERATION, 3600, 500, 200, 1).addIngredient(Ingredient.of(BloodMagicItems.SIMPLE_CATALYST.get())).addIngredient(Ingredient.of(Items.GHAST_TEAR)).build(consumer, BloodMagic.rl(basePath + "regen"));
