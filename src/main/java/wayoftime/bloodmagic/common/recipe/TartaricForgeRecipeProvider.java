...
public class TartaricForgeRecipeProvider implements ISubRecipeProvider
{
	...
	public void addRecipes(Consumer<IFinishedRecipe> consumer)
	{
		...
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicBlocks.DEMON_PYLON.get()), 400, 50, Ingredient.fromItems(BloodMagicItems.RAW_CRYSTAL.get(), BloodMagicItems.CORROSIVE_CRYSTAL.get(), BloodMagicItems.VENGEFUL_CRYSTAL.get(), BloodMagicItems.DESTRUCTIVE_CRYSTAL.get(), BloodMagicItems.STEADFAST_CRYSTAL.get()), Ingredient.fromTag(Tags.Items.STONE), Ingredient.fromTag(Tags.Items.GEMS_LAPIS), Ingredient.fromTag(Tags.Items.STORAGE_BLOCKS_IRON)).build(consumer, BloodMagic.rl(basePath + "demon_pylon"));

		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.MASTER_NODE_UPGRADE.get()), 400, 50, Ingredient.fromTag(Tags.Items.INGOTS_IRON), Ingredient.fromTag(Tags.Items.INGOTS_IRON), Ingredient.fromTag(Tags.Items.GLASS), Ingredient.fromTag(Tags.Items.STORAGE_BLOCKS_LAPIS)).build(consumer, BloodMagic.rl(basePath + "master_node_upgrade"));
...
//		smeltingHolder.toItemStack(stack);
		...
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.RAW_CRYSTAL_CATALYST.get()), 400, 20, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.POTATO)).build(consumer, BloodMagic.rl(basePath + "raw_catalyst"));
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.CORROSIVE_CRYSTAL_CATALYST.get()), 400, 20, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.WHEAT_SEEDS)).build(consumer, BloodMagic.rl(basePath + "corrosive_catalyst"));
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.DESTRUCTIVE_CRYSTAL_CATALYST.get()), 400, 20, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.BEETROOT)).build(consumer, BloodMagic.rl(basePath + "destructive_catalyst"));
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.VENGEFUL_CRYSTAL_CATALYST.get()), 400, 20, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.MELON_SEEDS)).build(consumer, BloodMagic.rl(basePath + "vengeful_catalyst"));
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.STEADFAST_CRYSTAL_CATALYST.get()), 400, 20, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.PUMPKIN_SEEDS)).build(consumer, BloodMagic.rl(basePath + "steadfast_catalyst"));
