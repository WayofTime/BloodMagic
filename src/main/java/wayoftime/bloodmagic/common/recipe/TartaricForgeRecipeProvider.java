...
//		smeltingHolder.toItemStack(stack);
		...
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.RAW_CRYSTAL_CATALYST.get()), 400, 30, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.POTATO)).build(consumer, BloodMagic.rl(basePath + "raw_catalyst"));
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.CORROSIVE_CRYSTAL_CATALYST.get()), 400, 30, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.WHEAT_SEEDS)).build(consumer, BloodMagic.rl(basePath + "corrosive_catalyst"));
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.DESTRUCTIVE_CRYSTAL_CATALYST.get()), 400, 30, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.BEETROOT)).build(consumer, BloodMagic.rl(basePath + "destructive_catalyst"));
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.VENGEFUL_CRYSTAL_CATALYST.get()), 400, 30, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.MELON_SEEDS)).build(consumer, BloodMagic.rl(basePath + "vengeful_catalyst"));
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.STEADFAST_CRYSTAL_CATALYST.get()), 400, 30, Ingredient.fromTag(Tags.Items.CROPS_NETHER_WART), Ingredient.fromItems(BloodMagicItems.TAU_OIL.get()), Ingredient.fromTag(BloodMagicTags.DUST_SULFUR), Ingredient.fromItems(Items.PUMPKIN_SEEDS)).build(consumer, BloodMagic.rl(basePath + "steadfast_catalyst"));
