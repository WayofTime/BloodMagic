...
public class TartaricForgeRecipeProvider implements ISubRecipeProvider
{
	...
	public void addRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.PRIMITIVE_CRYSTALLINE_RESONATOR.get()), 1200, 200, Ingredient.of(Tags.Items.STONE), Ingredient.of(Tags.Items.INGOTS), Ingredient.of(BloodMagicItems.RAW_CRYSTAL.get()), Ingredient.of(BloodMagicItems.RAW_CRYSTAL.get())).build(consumer, BloodMagic.rl(basePath + "primitive_crystalline_resonator"));
		...
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicBlocks.SHAPED_CHARGE_DEEP.get(), 4), 80, 2.5, Ingredient.of(Tags.Items.STORAGE_BLOCKS_COPPER), Ingredient.of(Items.CHARCOAL)).build(consumer, BloodMagic.rl(basePath + "shaped_charge_deep"));
