...
public class TartaricForgeRecipeProvider implements ISubRecipeProvider
{
	...
	public void addRecipes(Consumer<FinishedRecipe> consumer)
	{
		...
		TartaricForgeRecipeBuilder.tartaricForge(new ItemStack(BloodMagicItems.MASTER_NODE_UPGRADE_SPEED.get()), 400, 50, Ingredient.of(Tags.Items.INGOTS_GOLD), Ingredient.of(Tags.Items.INGOTS_GOLD), Ingredient.of(Tags.Items.GLASS), Ingredient.of(Tags.Items.STORAGE_BLOCKS_REDSTONE)).build(consumer, BloodMagic.rl(basePath + "master_node_upgrade_speed"));
