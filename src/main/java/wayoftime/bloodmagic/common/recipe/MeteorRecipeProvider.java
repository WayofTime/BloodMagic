...
public class MeteorRecipeProvider implements ISubRecipeProvider
{
	...
	public void addRecipes(Consumer<IFinishedRecipe> consumer)
	{
		...
		MeteorRecipeBuilder.meteor(Ingredient.fromTag(Tags.Items.STORAGE_BLOCKS_IRON), 0).addLayer(new MeteorLayer(10, 100, Blocks.STONE).addWeightedTag(Tags.Blocks.ORES_IRON, 50).addWeightedTag(Tags.Blocks.ORES_COAL, 35)).addLayer(new MeteorLayer(4, 100, Blocks.COAL_BLOCK).addWeightedTag(Tags.Blocks.ORES_DIAMOND, 70).addWeightedTag(Tags.Blocks.ORES_COAL, 25)).build(consumer, BloodMagic.rl(basePath + "iron"));
