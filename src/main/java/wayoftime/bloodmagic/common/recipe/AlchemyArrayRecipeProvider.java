...
//				+ "airsigil"));
        ...
        // TODO update to a proper one if we get a texture for it
        AlchemyArrayRecipeBuilder.array(BloodMagic.rl("textures/models/alchemyarrays/stupidarray.png"), Ingredient.of(BloodMagicItems.REAGENT_FROST.get()), Ingredient.of(BloodMagicItems.IMBUED_SLATE.get()), new ItemStack(BloodMagicItems.ICE_SIGIL.get())).build(consumer, BloodMagic.rl(basePath + "frostsigil"));
