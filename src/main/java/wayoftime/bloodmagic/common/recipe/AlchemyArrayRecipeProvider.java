...
//				+ "airsigil"));
		...
		AlchemyArrayRecipeBuilder.array(BloodMagic.rl("textures/models/alchemyarrays/suppressionsigil.png"), Ingredient.fromItems(BloodMagicItems.REAGENT_SUPPRESSION.get()), Ingredient.fromItems(BloodMagicItems.DEMONIC_SLATE.get()), new ItemStack(BloodMagicItems.SUPPRESSION_SIGIL.get())).build(consumer, BloodMagic.rl(basePath + "suppressionsigil"));
		AlchemyArrayRecipeBuilder.array(BloodMagic.rl("textures/models/alchemyarrays/teleportation.png"), Ingredient.fromItems(BloodMagicItems.REAGENT_TELEPOSITION.get()), Ingredient.fromItems(BloodMagicItems.DEMONIC_SLATE.get()), new ItemStack(BloodMagicItems.TELEPOSITION_SIGIL.get())).build(consumer, BloodMagic.rl(basePath + "telepositionsigil"));
