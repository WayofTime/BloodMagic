...
//	public static final RegistryObject<Item> CONCENTRATED_CATALYST = BASICITEMS.register("concentratedcatalyst", () -> new ItemBase());
    ...
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_STONE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_STONE.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_POLISHED_STONE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_POLISHED_STONE.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_TILE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_TILE.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_TILE_SPECIAL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tilespecial_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_TILE_SPECIAL.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_BRICK_1_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_BRICK_1.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_BRICK_2_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick2_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_BRICK_2.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_BRICK_3_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick3_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_BRICK_3.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_SMALL_BRICK_BLOCK = DECORATIVE_DUNGEON.register("dungeon_smallbrick_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_SMALL_BRICK.get(), new Item.Properties()));

    public static final RegistryObject<Item> CORROSIVE_DUNGEON_TILE_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_slab_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_TILE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_BRICK_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_slab_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_BRICK_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_STONE_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_slab_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_STONE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_POLISHED_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_slab_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_POLISHED_SLAB.get(), new Item.Properties()));

    public static final RegistryObject<Item> CORROSIVE_DUNGEON_POLISHED_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_stairs_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_POLISHED_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_STONE_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_stairs_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_STONE_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_BRICK_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_stairs_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_BRICK_STAIRS.get(), new Item.Properties()));

    public static final RegistryObject<Item> CORROSIVE_DUNGEON_POLISHED_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_wall_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_POLISHED_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_BRICK_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_wall_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_BRICK_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_TILE_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_wall_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_TILE_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> CORROSIVE_DUNGEON_STONE_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_wall_corrosive", () -> new BlockItem(BloodMagicBlocks.CORROSIVE_DUNGEON_STONE_WALL.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_STONE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_STONE.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_POLISHED_STONE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_POLISHED_STONE.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_TILE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_TILE.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_TILE_SPECIAL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tilespecial_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_TILE_SPECIAL.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_BRICK_1_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_BRICK_1.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_BRICK_2_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick2_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_BRICK_2.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_BRICK_3_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick3_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_BRICK_3.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_SMALL_BRICK_BLOCK = DECORATIVE_DUNGEON.register("dungeon_smallbrick_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_SMALL_BRICK.get(), new Item.Properties()));

    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_TILE_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_slab_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_TILE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_BRICK_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_slab_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_BRICK_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_STONE_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_slab_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_STONE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_POLISHED_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_slab_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_POLISHED_SLAB.get(), new Item.Properties()));

    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_POLISHED_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_stairs_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_POLISHED_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_STONE_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_stairs_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_STONE_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_BRICK_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_stairs_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_BRICK_STAIRS.get(), new Item.Properties()));

    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_POLISHED_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_wall_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_POLISHED_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_BRICK_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_wall_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_BRICK_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_TILE_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_wall_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_TILE_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_STONE_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_wall_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_STONE_WALL.get(), new Item.Properties()));

    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_POLISHED_GATE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_gate_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_POLISHED_GATE.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_BRICK_GATE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_gate_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_BRICK_GATE.get(), new Item.Properties()));

    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_PILLAR_CENTER_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_center_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_PILLAR_CENTER.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_PILLAR_SPECIAL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_special_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_PILLAR_SPECIAL.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_PILLAR_CAP_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_cap_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_PILLAR_CAP.get(), new Item.Properties()));

    public static final RegistryObject<Item> DESTRUCTIVE_DUNGEON_EYE = DECORATIVE_DUNGEON.register("dungeon_eye_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_DUNGEON_EYE.get(), new Item.Properties()));
    public static final RegistryObject<Item> DESTRUCTIVE_HELLFORGED_BLOCK = DECORATIVE_DUNGEON.register("dungeon_metal_destructive",() -> new BlockItem(BloodMagicBlocks.DESTRUCTIVE_HELLFORGED_BLOCK.get(), new Item.Properties()));

    public static final RegistryObject<Item> STEADFAST_DUNGEON_STONE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_STONE.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_POLISHED_STONE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_POLISHED_STONE.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_TILE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_TILE.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_TILE_SPECIAL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tilespecial_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_TILE_SPECIAL.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_BRICK_1_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_BRICK_1.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_BRICK_2_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick2_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_BRICK_2.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_BRICK_3_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick3_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_BRICK_3.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_SMALL_BRICK_BLOCK = DECORATIVE_DUNGEON.register("dungeon_smallbrick_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_SMALL_BRICK.get(), new Item.Properties()));

    public static final RegistryObject<Item> STEADFAST_DUNGEON_TILE_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_slab_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_TILE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_BRICK_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_slab_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_BRICK_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_STONE_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_slab_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_STONE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_POLISHED_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_slab_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_POLISHED_SLAB.get(), new Item.Properties()));

    public static final RegistryObject<Item> STEADFAST_DUNGEON_POLISHED_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_stairs_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_POLISHED_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_STONE_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_stairs_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_STONE_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_BRICK_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_stairs_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_BRICK_STAIRS.get(), new Item.Properties()));

    public static final RegistryObject<Item> STEADFAST_DUNGEON_POLISHED_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_wall_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_POLISHED_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_BRICK_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_wall_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_BRICK_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_TILE_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_wall_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_TILE_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_STONE_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_wall_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_STONE_WALL.get(), new Item.Properties()));

    public static final RegistryObject<Item> STEADFAST_DUNGEON_POLISHED_GATE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_gate_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_POLISHED_GATE.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_BRICK_GATE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_gate_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_BRICK_GATE.get(), new Item.Properties()));

    public static final RegistryObject<Item> STEADFAST_DUNGEON_PILLAR_CENTER_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_center_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_PILLAR_CENTER.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_PILLAR_SPECIAL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_special_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_PILLAR_SPECIAL.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_DUNGEON_PILLAR_CAP_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_cap_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_PILLAR_CAP.get(), new Item.Properties()));

    public static final RegistryObject<Item> STEADFAST_DUNGEON_EYE = DECORATIVE_DUNGEON.register("dungeon_eye_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_DUNGEON_EYE.get(), new Item.Properties()));
    public static final RegistryObject<Item> STEADFAST_HELLFORGED_BLOCK = DECORATIVE_DUNGEON.register("dungeon_metal_steadfast", () -> new BlockItem(BloodMagicBlocks.STEADFAST_HELLFORGED_BLOCK.get(), new Item.Properties()));

    public static final RegistryObject<Item> VENGEFUL_DUNGEON_STONE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_STONE.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_POLISHED_STONE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_POLISHED_STONE.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_TILE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_TILE.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_TILE_SPECIAL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tilespecial_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_TILE_SPECIAL.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_BRICK_1_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_BRICK_1.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_BRICK_2_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick2_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_BRICK_2.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_BRICK_3_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick3_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_BRICK_3.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_SMALL_BRICK_BLOCK = DECORATIVE_DUNGEON.register("dungeon_smallbrick_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_SMALL_BRICK.get(), new Item.Properties()));

    public static final RegistryObject<Item> VENGEFUL_DUNGEON_TILE_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_slab_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_TILE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_BRICK_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_slab_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_BRICK_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_STONE_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_slab_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_STONE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_POLISHED_SLAB_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_slab_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_POLISHED_SLAB.get(), new Item.Properties()));

    public static final RegistryObject<Item> VENGEFUL_DUNGEON_POLISHED_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_stairs_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_POLISHED_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_STONE_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_stairs_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_STONE_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_BRICK_STAIRS_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_stairs_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_BRICK_STAIRS.get(), new Item.Properties()));

    public static final RegistryObject<Item> VENGEFUL_DUNGEON_POLISHED_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_wall_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_POLISHED_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_BRICK_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_wall_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_BRICK_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_TILE_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_tile_wall_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_TILE_WALL.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_STONE_WALL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_stone_wall_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_STONE_WALL.get(), new Item.Properties()));

    public static final RegistryObject<Item> VENGEFUL_DUNGEON_POLISHED_GATE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_polished_gate_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_POLISHED_GATE.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_BRICK_GATE_BLOCK = DECORATIVE_DUNGEON.register("dungeon_brick1_gate_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_BRICK_GATE.get(), new Item.Properties()));

    public static final RegistryObject<Item> VENGEFUL_DUNGEON_PILLAR_CENTER_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_center_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_PILLAR_CENTER.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_PILLAR_SPECIAL_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_special_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_PILLAR_SPECIAL.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_DUNGEON_PILLAR_CAP_BLOCK = DECORATIVE_DUNGEON.register("dungeon_pillar_cap_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_PILLAR_CAP.get(), new Item.Properties()));

    public static final RegistryObject<Item> VENGEFUL_DUNGEON_EYE = DECORATIVE_DUNGEON.register("dungeon_eye_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_DUNGEON_EYE.get(), new Item.Properties()));
    public static final RegistryObject<Item> VENGEFUL_HELLFORGED_BLOCK = DECORATIVE_DUNGEON.register("dungeon_metal_vengeful", () -> new BlockItem(BloodMagicBlocks.VENGEFUL_HELLFORGED_BLOCK.get(), new Item.Properties()));
