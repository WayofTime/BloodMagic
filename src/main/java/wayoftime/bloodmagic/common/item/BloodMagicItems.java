...
//	public static final RegistryObject<Item> WEAK_BLOOD_ORB = BASICITEMS.register("weakbloodorb", () -> new ItemBloodOrb(WEAK_ORB_INSTANCE));
	...
	public static final RegistryObject<Item> SPIKE_TRAP = ITEMS.register("spike_trap", () -> new BlockItem(BloodMagicBlocks.SPIKE_TRAP.get(), new Item.Properties().group(BloodMagic.TAB)));
