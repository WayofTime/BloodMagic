...
public class ScreenMasterRoutingNode extends ScreenBase<ContainerMasterRoutingNode>
{
	...
	{
		this.font.draw(stack, Component.translatable("tile.bloodmagic.masterroutingnode.name"), 8, 5, 4210752);
		this.font.draw(stack, Component.translatable("container.inventory"), 8, 27, 4210752);
	}
