...
public class BlockHomHeart extends BlockContainer
{
	...
	{
		topIcon = iconRegister.registerIcon("AlchemicalWizardry:HomHeart_top");
		bottomIcon = iconRegister.registerIcon("AlchemicalWizardry:HomHeart_bottom");
		sideIcon = iconRegister.registerIcon("AlchemicalWizardry:HomHeart_side");
	}
