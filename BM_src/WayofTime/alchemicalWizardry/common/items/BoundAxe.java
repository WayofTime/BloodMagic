...
public class BoundAxe extends ItemAxe implements IBindable
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:BoundAxe_activated");
		activeIcon = iconRegister.registerIcon("AlchemicalWizardry:BoundAxe_activated");
