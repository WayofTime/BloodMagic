...
public class DemonPlacer extends Item
{
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			Entity entity = spawnCreature(par3World, par1ItemStack.getItemDamage(), par4 + 0.5D, par5 + d0, par6 + 0.5D, par1ItemStack);
		...
		else
		{
			...
			else
			{
				if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
				{
					...
					{
						Entity entity = spawnCreature(par2World, par1ItemStack.getItemDamage(), i, j, k, par1ItemStack);
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:DemonPlacer");
	}
}
