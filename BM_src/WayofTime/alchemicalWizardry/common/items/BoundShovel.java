...
public class BoundShovel extends ItemSpade implements IBindable
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:BoundShovel_activated");
		activeIcon = iconRegister.registerIcon("AlchemicalWizardry:BoundShovel_activated");
