...
public class SigilOfWind extends EnergyItems implements ArmourUpgrade
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:WindSigil_deactivated");
		activeIcon = iconRegister.registerIcon("AlchemicalWizardry:WindSigil_activated");
		passiveIcon = iconRegister.registerIcon("AlchemicalWizardry:WindSigil_deactivated");
	}
