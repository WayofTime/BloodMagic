...
public class SigilOfElementalAffinity extends EnergyItems
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:SigilOfTheFastMiner");
		activeIcon = iconRegister.registerIcon("AlchemicalWizardry:ElementalSigil_activated");
		passiveIcon = iconRegister.registerIcon("AlchemicalWizardry:ElementalSigil_deactivated");
	}
