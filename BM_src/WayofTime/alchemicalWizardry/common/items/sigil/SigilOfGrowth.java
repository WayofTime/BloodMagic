...
public class SigilOfGrowth extends EnergyItems implements ArmourUpgrade
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:GrowthSigil_deactivated");
		activeIcon = iconRegister.registerIcon("AlchemicalWizardry:GrowthSigil_activated");
		passiveIcon = iconRegister.registerIcon("AlchemicalWizardry:GrowthSigil_deactivated");
	}
