...
public class SigilOfHaste extends EnergyItems implements ArmourUpgrade
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:HasteSigil_deactivated");
		activeIcon = iconRegister.registerIcon("AlchemicalWizardry:HasteSigil_activated");
		passiveIcon = iconRegister.registerIcon("AlchemicalWizardry:HasteSigil_deactivated");
	}
