...
public class ArmourInhibitor extends EnergyItems
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:ArmourInhibitor_deactivated");
		activeIcon = iconRegister.registerIcon("AlchemicalWizardry:ArmourInhibitor_activated");
		passiveIcon = iconRegister.registerIcon("AlchemicalWizardry:ArmourInhibitor_deactivated");
	}
