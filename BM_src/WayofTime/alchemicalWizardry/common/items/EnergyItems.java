		...
		if (!player.capabilities.isCreativeMode)
		{
			...
			if (world != null)
			{
				...
				if (particles)
				{
					...
					world.playSoundEffect((float)player.posX + 0.5F, (float)player.posY + 0.5F, (float)player.posZ + 0.5F, "random.fizz", 0.5F, 2.6F + (world.rand.nextFloat() - world.rand.nextFloat()) * 0.8F);
				}
			}
