...
public class AlchemyFlask extends Item
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:PotionFlask");
	}
	...
	{
		if (isPotionThrowable(par1ItemStack))
		{
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		if (par1ItemStack.getItemDamage() < par1ItemStack.getMaxDamage())
		{
			if (isPotionThrowable(par1ItemStack))
			{
				if (!par2World.isRemote)
				{
					EntityPotion entityPotion = getEntityPotion(par1ItemStack, par2World, par3EntityPlayer);
