...
public class EnergyBattery extends Item implements ArmourUpgrade, IBindable
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:EnergyBattery");
	}
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		PacketDispatcher.sendPacketToServer(PacketHandler.getPacket(itemTag.getString("ownerName"), 200, getMaxEssence()));
	...
	public int damageItem(ItemStack par1ItemStack, int par2int)
	{
		...
		int before = getDamage(par1ItemStack);
		setDamage(par1ItemStack, getDamage(par1ItemStack) + par2int);
		return par2int - (getDamage(par1ItemStack) - before);
	}
