...
public class FocusBloodBlast extends FocusBase
{
	...
	{
		super(par1);
		setUnlocalizedName("focusBloodBlast");
		setEnergyUsed(100);
	}
			...
			try
			{
				...
				if (cooldown >= maxCooldown)
				{
					...
					if ((Boolean) consumeAllVis.invoke(item, stack, par3EntityPlayer, getVisCost(), true))
					{
						...
						{
							syphonBatteries(focusStack, par3EntityPlayer, 100);
						}
						...
						if (!world.isRemote)
						{
							...
							world.spawnEntityInWorld(new EnergyBlastProjectile(world, par3EntityPlayer, 5));
