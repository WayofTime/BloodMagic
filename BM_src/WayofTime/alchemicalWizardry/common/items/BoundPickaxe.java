...
public class BoundPickaxe extends ItemPickaxe implements IBindable
{
	...
	{
		itemIcon = iconRegister.registerIcon("AlchemicalWizardry:BoundPickaxe_activated");
		activeIcon = iconRegister.registerIcon("AlchemicalWizardry:BoundPickaxe_activated");
	...
	{
		return par1Block == Block.obsidian ? true : par1Block != Block.blockDiamond && par1Block != Block.oreDiamond ? par1Block != Block.oreEmerald && par1Block != Block.blockEmerald ? par1Block != Block.blockGold && par1Block != Block.oreGold ? par1Block != Block.blockIron && par1Block != Block.oreIron ? par1Block != Block.blockLapis && par1Block != Block.oreLapis ? par1Block != Block.oreRedstone && par1Block != Block.oreRedstoneGlowing ? par1Block.blockMaterial == Material.rock ? true : par1Block.blockMaterial == Material.iron ? true : par1Block.blockMaterial == Material.anvil : true : true : true : true : true : true;
	}
