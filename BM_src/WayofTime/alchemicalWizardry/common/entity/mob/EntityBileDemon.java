...
public class EntityBileDemon extends EntityDemon
{
	...
	protected void applyEntityAttributes()
	{
		...
		getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(0.20000001192092896D);
	...
	public boolean interact(EntityPlayer par1EntityPlayer)
	{
		...
		else if (itemstack != null && itemstack.itemID == AlchemicalWizardry.weakBloodOrb.itemID && !isAngry())
		{
			if (!par1EntityPlayer.capabilities.isCreativeMode)
			{
				--itemstack.stackSize;
