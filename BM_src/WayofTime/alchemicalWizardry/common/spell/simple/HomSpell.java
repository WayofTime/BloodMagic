...
public abstract class HomSpell implements ISimpleSpell
{
	...
	{
		offensiveRangedEnergy = offensiveRanged;
		offensiveMeleeEnergy = offensiveMelee;
		defensiveEnergy = defensive;
	...
	public ItemStack useSpell(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
	{
		...
		if (par3EntityPlayer.isSneaking())
		{
			if (paradigm < 3)
			{
				setSpellParadigm(par1ItemStack, paradigm + 1);
			}
			else
			{
				setSpellParadigm(par1ItemStack, 0);
			}
		...
		{
		case 0:
			return onOffensiveRangedRightClick(par1ItemStack, par2World, par3EntityPlayer);

		case 1:
			return onOffensiveMeleeRightClick(par1ItemStack, par2World, par3EntityPlayer);

		case 2:
			return onDefensiveRightClick(par1ItemStack, par2World, par3EntityPlayer);

		case 3:
			return onEnvironmentalRightClick(par1ItemStack, par2World, par3EntityPlayer);
		}
