...
public class ModelBileDemon extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		rightArmSpacer.rotateAngleX = MathHelper.cos(f * 0.3662F + (float)Math.PI) * 1.0F * f1;
		leftArmSpacer.rotateAngleX = MathHelper.cos(f * 0.3662F) * 1.0F * f1;
		leftBall.rotateAngleX = head.rotateAngleX;
		leftBall.rotateAngleY = head.rotateAngleY;
		rightBall.rotateAngleX = head.rotateAngleX;
		rightBall.rotateAngleY = head.rotateAngleY;
		leftChain.rotateAngleX = head.rotateAngleX;
		leftChain.rotateAngleY = head.rotateAngleY;
		rightChain.rotateAngleX = head.rotateAngleX;
		rightChain.rotateAngleY = head.rotateAngleY;
