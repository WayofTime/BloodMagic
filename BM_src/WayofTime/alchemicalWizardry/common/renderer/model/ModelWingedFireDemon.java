...
public class ModelWingedFireDemon extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		leftHorn1.rotateAngleX = head.rotateAngleX;
		leftHorn1.rotateAngleY = head.rotateAngleY;
		leftHorn2.rotateAngleX = head.rotateAngleX;
		leftHorn2.rotateAngleY = head.rotateAngleY;
		rightHorn1.rotateAngleX = head.rotateAngleX;
		rightHorn1.rotateAngleY = head.rotateAngleY;
		rightHorn2.rotateAngleX = head.rotateAngleX;
		rightHorn2.rotateAngleY = head.rotateAngleY;
