...
public class ModelIceDemon extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		rightArm.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1;
		leftArm.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.4F * f1;
		leftHorn.rotateAngleX = head.rotateAngleX + 0.4363323F;
		leftHorn.rotateAngleY = head.rotateAngleY;
		rightHorn.rotateAngleX = head.rotateAngleX + 0.4363323F;
		rightHorn.rotateAngleY = head.rotateAngleY;
		rightIcicle1.rotateAngleX = rightArm.rotateAngleX;
		rightIcicle2.rotateAngleX = rightArm.rotateAngleX;
		rightIcicle3.rotateAngleX = rightArm.rotateAngleX;
		leftIcicle1.rotateAngleX = leftArm.rotateAngleX;
		leftIcicle2.rotateAngleX = leftArm.rotateAngleX;
		leftIcicle3.rotateAngleX = leftArm.rotateAngleX;
		rightWrist.rotateAngleX = rightArm.rotateAngleX;
		leftWrist.rotateAngleX = leftArm.rotateAngleX;
	}
}
