...
public class ModelLowerGuardian extends ModelBase
{
	...
	public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4)
	{
		...
		if (i > 0)
		{
			rightLeg.rotateAngleX = -2.0F + 1.5F * func_78172_a(i - par4, 10.0F);
			rightFoot.rotateAngleX = -2.0F + 1.5F * func_78172_a(i - par4, 10.0F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		leftLeg.rotateAngleX = MathHelper.cos(f * 0.3662F) * 1.0F * f1;
		rightLeg.rotateAngleX = MathHelper.cos(f * 0.3662F + (float)Math.PI) * 1.0F * f1;
		leftFoot.rotateAngleX = MathHelper.cos(f * 0.3662F) * 1.0F * f1;
		rightFoot.rotateAngleX = MathHelper.cos(f * 0.3662F + (float)Math.PI) * 1.0F * f1;
		rightArm.rotateAngleX = MathHelper.cos(f * 0.3662F + (float)Math.PI) * 1.0F * f1;
		leftArm.rotateAngleX = MathHelper.cos(f * 0.3662F) * 1.0F * f1;
		hornAppendage1.rotateAngleX = Head.rotateAngleX;
		hornAppendage1.rotateAngleY = Head.rotateAngleY;
		hornAppendage2.rotateAngleX = Head.rotateAngleX;
		hornAppendage2.rotateAngleY = Head.rotateAngleY;
		hornAppendage3.rotateAngleX = Head.rotateAngleX;
		hornAppendage3.rotateAngleY = Head.rotateAngleY;
		hornAppendage4.rotateAngleX = Head.rotateAngleX;
		hornAppendage4.rotateAngleY = Head.rotateAngleY;
