...
public class ModelBoulderFist extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
	{
		...
		leftFoot.rotateAngleX = MathHelper.cos(f * 0.6662F) * 0.8F * f1;
		rightFoot.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 0.8F * f1;
		leftLeg1.rotateAngleX = leftFoot.rotateAngleX - (float)Math.PI / 4F;
		rightLeg1.rotateAngleX = rightFoot.rotateAngleX - (float)Math.PI / 4F;
		leftLeg2.rotateAngleX = leftFoot.rotateAngleX - (float)Math.PI / 4F;
		rightLeg2.rotateAngleX = rightFoot.rotateAngleX - (float)Math.PI / 4F;
		rightArm.rotateAngleX = MathHelper.cos(f * 0.6662F + (float)Math.PI) * 0.9f * f1;
		leftArm.rotateAngleX = MathHelper.cos(f * 0.6662F) * 0.9f * f1;
		leftFist.rotateAngleX = leftArm.rotateAngleX;
		rightFist.rotateAngleX = rightArm.rotateAngleX;
	}
}